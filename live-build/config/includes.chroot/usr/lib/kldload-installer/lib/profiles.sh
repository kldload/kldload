...
k_install_system_files() {
  ...
  mkdir -p "${target}/usr/local/sbin"
  for bin in kspawn kldload-ca kldload-tls-cert kldload-wait-for-ip kldload-bounce-tls-services kldload-session kldload-headlamp-install kldload-secure-boot; do
