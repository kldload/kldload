...
ICONS = {
 ...
 "kldload-metrics":metrics, "bob-chat":bob, "bob-gaming":bob_gaming,
    # The Ollama tile wears the LAMP, in steel rather than Bob's purple.
    # Operator call 2026-08-13: the llama drawings were rejected and the lamp
    # kept, so the two tiles share a silhouette and are told apart by colour —
    # Bob stays purple, the model runner goes steel. Same drawing function on
    # purpose: one shape to maintain, and the palette carries the distinction.
    "ollama":bob,
...
COLORS = {
 ...
 # ai — violet
 "bob-chat":"#c79be0","bob-gaming":"#d3a8ec","ollama":"#9aa6b4",
...
ACCENTS2 = {
 ...
 "bob-chat":"#ffafd2","bob-gaming":"#ffafd2","ollama":"#d8e3ee",
