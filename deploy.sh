...
cmd_pxe_serve() {
    ...
    if ((menu)); then
        ...
        # outright. Passwords come from a per-MAC seed file at mode 0600, or
        ...
        # transport.
        {
            ...
            local _t
            for _t in "tsb:sb" "tzfs:zfs" "tenc:enc" "tbimg:bimg"; do
                printf ':%s\n' "${_t%%:*}"
            ...
            printf 'kldload.encrypt=${enc} kldload.secureboot=${sb} kldload.buildimages=${bimg}\n'
