...
_pass() { echo -e "  \033[1;32mPASS\033[0m  $*"; ((++PASS)); }
_fail() { echo -e "  \033[1;31mFAIL\033[0m  $1 — $2"; ((++FAIL)); }
_warn() { echo -e "  \033[1;33mWARN\033[0m  $1 — $2"; ((++WARN)); }
_section() { echo ""; echo -e "\033[1;36m=== $* ===\033[0m"; }
